...
extension PassportModalViewController: ImageCallback  {
    func documentFrontCallBack(docScanResult: DocScanResult) {
        ...
        print("documentFrontCallBack: CaptureType:\(docScanResult.captureType ?? -1) dataExtracted: \(docScanResult.dataExtracted ?? false) sessionId: \(docScanResult.sessionId ?? "" ) sessionToken: \(docScanResult.sessionToken ?? "")")
