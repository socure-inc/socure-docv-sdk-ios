...
extension ModalViewController: ImageCallback  {
    func documentFrontCallBack(docScanResult: DocScanResult) {
        ...
        print("documentFrontCallBack: CaptureType:\(docScanResult.captureType ?? -1) sessionId: \(docScanResult.sessionId ?? "")")
    ...
    func documentBackCallBack(docScanResult: DocScanResult) {
        ...
        print("documentBackCallBack: CaptureType:\(docScanResult.captureType ?? -1) dataExtracted: \(docScanResult.dataExtracted ?? false) sessionId: \(docScanResult.sessionId ?? "")")
