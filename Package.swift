...
let package = Package(
    ...
    dependencies: [
        .package(
            ...
            .upToNextMinor(from: "4.9.0")
        )
    ],
    targets: [
        .binaryTarget(
            name: "SocureDocV",
            url: "https://sdk.socure.com/socure-sdks/docv/ios/socure-docv-5.5.0.zip",
            checksum: "beb431f7b1cb8fde1f298bd6c357671c688720e612213f3658c78428a9a2482b"
        ),
        .target(
